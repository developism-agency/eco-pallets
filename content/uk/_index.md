...
hero:
  ...
  label: |-
    ...
    **50+** Видів нестандартних піддонів
    ...
    - name: Вживані піддони різних розмірів
      ...
      modal:
        ...
        text: >-
          ...
          Пропонуємо якісні вживані піддони, які практично не поступаються новій продукції.\
    ...
    - name: Піддони нестандартних розмірів
      ...
      modal:
        ...
        text: >-
          ...
          Пропонуємо виготовлення піддонів нестандартних розмірів, які мають задовольнити потреби будь-якого бізнесу.\
    ...
    - name: Палетна заготовка
      ...
      modal:
        ...
        text: >-
          ...
          Пропонуємо палетну заготовку — якісні дерев'яні дошки євро розмірів, розпиляні на автоматичній розпилювальній лінії та призначені для виготовлення піддонів.
...
utils:
  ...
  validation:
    required: Електронна адреса неправильна
